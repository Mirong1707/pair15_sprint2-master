...
import {getRandomInt} from "../../GeneralClasses/General.js";
...
export default class Instruction {
    ...
    move(bug) {
        ...
        assert(this.world.adjacent(bug.getPosition(), bug.direction) === this.world.cellAt(this.world.sensedCell(bug.getPosition(), bug.direction)), "lox")
        this.world.cellAt(bug.getPosition()).bug = null;
        bug.setPosition(this.world.sensedCell(bug.getPosition(), bug.direction));
        //assert(this.world.cellAt(bug.getPosition()).bug === null)
